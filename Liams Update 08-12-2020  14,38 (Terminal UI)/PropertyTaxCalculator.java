...
public class PropertyTaxCalculator
{
    ...
    //Property property = new Property("pName",100000,"pAddress","E41F5C2", 2000,"C", "Y");
    ...
    public double getPropByYear(Property property1, int year)
    {
        double overDueTax = 0;
        for(Property property : property1.getAllProperties())
        {
            int yearOne = property.getYearCreated(); 
