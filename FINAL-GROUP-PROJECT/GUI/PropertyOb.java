...
/**
 * Property Object used for the Owner
 * @author Hannah O'Hea
 * @version 9/12/2020
 */
public class PropertyOb {
   ...
   // private static double amountPaid;
    ...
    public PropertyOb(int propNumb,String name, String address, String eircode, double value, String principal, String location,
    ...
    public boolean equals(Object o) {
        ...
        PropertyOb property = (PropertyOb) o;
        return propNumb == property.propNumb && Double.compare(property.value, value) == 0 && principal == property.principal && location == property.location && year == property.year  && Objects.equals(name, property.name) && Objects.equals(address, property.address) && Objects.equals(eircode, property.eircode);
    }
